...
class ResourceMeta_IndexController extends Omeka_Controller_AbstractActionController
{
    ...
    public function editAction()
    {
        ...
        $metaNamesForSelect = array();
        foreach ($this->metaNames as $metaNameGroup => $metaNames) {
            $metaNamesForSelect[$metaNameGroup] = array_combine($metaNames, $metaNames);
        }
        ...
        $this->view->meta_names_for_select = $metaNamesForSelect;
    }

    protected $metaNames = array(
        'BE Press' => array(
